...
classdef WindETH < handle
    properties (SetAccess = public)
        ...
        History        = stack(nan(100,3));
        HistoryCol     = {'JD','WindSpeed','WindAz'};
        %WindSpeedHistory
        %WindAzHistory
        %TimeHistory
    ...
    % getters/setters
    % there is no get/set here
    % as usually we would like to get the speed and Az measured at the same
    % time. Use getWind to update Speed/Az values.
...
%             
            ...
            % if status is ok than set the time of the last query
             ...
             WC.History.add([WC.JD, WC.WindSpeed, WC.WindAz]);
