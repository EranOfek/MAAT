function Cat=apply_tranclass(Cat,TranC,varargin)
% Apply forward transformation to X,Y coordinates in an AstCat object
% Package: @AstCat
% Description: Apply forward transformation to X,Y coordinates in an
%              AstCat object. See also TranClass/apply_tranclass.
...
% Example: Cat=apply_tranclass(Cat,TranC);
% Reliable: 2
%--------------------------------------------------------------------------
