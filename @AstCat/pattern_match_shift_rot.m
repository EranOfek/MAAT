...
%         [CatRot]=transform(AstT,CatFlip);
        ...
        % pattern matching:
%         [Res,IndBest]=pattern_match_shift(CatRot,Ref,InPar.MatchShiftPar{:},...
%                                             'CatSelect',{},...
%                                             'RefSelect',{},...
%                                             'MaxPeaksCheck',InPar.MaxPeaksCheckI);

                                        
        CatColInd = colname2ind(CatRot,InPar.ColCatXY);
        RefColInd = colname2ind(Ref,InPar.ColRefXY);
        

        [Res,IndBest] = pattern_match_shift(CatRot.(CatField)(:,CatColInd),...
...
%     [Res,IndBest,H2]=pattern_match_shift(CatRot,Ref,InPar.MatchShiftPar{:},...
%                                             'CatSel',[],...
%                                             'RefSel',[],...
%                                             'MaxPeaksCheck',InPar.MaxPeaksCheckF);

    [Res,IndBest,H2] = pattern_match_shift(CatRot.(CatField)(:,CatColInd),...
                                       Ref.(CatField)(:,RefColInd),...
                                       InPar.MatchShiftPar{:},...
                                       'MaxPeaksCheck',InPar.MaxPeaksCheckF);
