...
%              This program is replaced by wget_2mass.m
...
SearchProgExe = 'bin/vizquery/cdsclient-2.87/find2mass';
...
RunStr = sprintf('%s -c %f %f -r %f -max 200000 > %s',SEARCH_PROGRAM,RA.*RAD,Dec.*RAD,SearchRadius,TMP_CAT);
