...
% Calculate the center of mass and second moments of 2-dimensional matrix.
% Package: ImUtil.Im
% Description: Calculate the center of mass and second moments of
%              2-dimensional matrix.
%              OBSOLOETE: Use ImUtil.Im.im_moments instead.
...
%          N = 1000; B=100;
%          [M]=ImUtil.Im.center2d_cm(MatX,MatY,sqrt(G.*N+B));
% Notes: previously called: center2d_cm.m
% Reliable: 2
%------------------------------------------------------------------------------
