...
% Example: X=[4000:1:9000].'; Y=AstroUtil.spec.fun_gauss([1 6000 100],X);
%          Y=AstroUtil.spec.fun_gauss([1 6000 100],X,100);
%          GyessPar=AstroUtil.spec.fun_gauss('guess',[X Y]); % find initial parameters
%          Int = AstroUtil.spec.fun_gauss([1 6000 100],'int')
% Reliable: 2
%------------------------------------------------------------------------------
