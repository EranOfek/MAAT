...
c      real*8 x(m,n), y(m,n)
      real*8 Alpha(2), Mag(4)
      real*8 Output(*), Pars(*), ThetaXY(*)
c      integer m, n
...
c----- define pointers
      ...
      integer nlhs, nrhs
      integer m1, n1, m2, n2, siz
      real*8 MxPars(12000000)
...
c--------------------------------------------------
C     Get the size of the input par vector (3 x n).
c--------------------------------------------------
      m2 = mxGetM(prhs(2))
      n2 = mxGetN(prhs(2))
      if(n2 .ne. NoLines .or. m2 .ne. 3) then
         call mexErrMsgTxt('Input #2 is not a 3 x n vector.')
      endif
...
C     Load the data into Fortran arrays.
      ...
      call mxCopyPtrToReal8(MxPars_pr,    MxPars,    3*NoLines)
