...
switch model
    ...
    case 'msw'
        ...
        [L_BO,Tc_BO]=...
            AstroUtil.supernova.sn_cooling_msw(t_min*(1+redshift),'Type',Prog,'Rs',VecRs,'Vs',shiftdim(VecVs,-1),'Ms',shiftdim(VecMs,-2),'f_rho',shiftdim(VecFrho,-3),...
            'Model',model);

        [L_end,Tc_end]=...
            AstroUtil.supernova.sn_cooling_msw(t_max*(1+redshift),'Type',Prog,'Rs',VecRs,'Vs',shiftdim(VecVs,-1),'Ms',shiftdim(VecMs,-2),'f_rho',shiftdim(VecFrho,-3),...
            'Model',model);
        t_BO = t_min;
        t_opac = times.t_opac;
