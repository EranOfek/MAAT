...
pause(0.001);
GraphsNumber_SelectionChangedFcn(hObject, eventdata, handles);
...
if ~isempty(handles.Plot.UserData)
    for iband = 1:length(handles.Plot.UserData.plots)
        ...
        if ~isempty(handles.Plot.UserData.bg(iband))
...
!screen -dmS grid nice -n 19 matlab -nodisplay -nosplash -nodesktop -r "load('grid.mat');prepare_LCs(grid.sn_name,grid.model,grid.Vs.vec*10^8.5,grid.Rs.vec,grid.Ms.vec,grid.frho.vec,grid.Ebv.vec,grid.prog);AstroUtil.supernova.SOPRANOS.calcGrid(grid.sn_name, grid.t0.vec, grid.Ebv.vec, grid.model, 0, grid.BGbands);exit" &
...
AstroUtil.supernova.SOPRANOS.plotGrid([handles.SOPRANOS.UserData.data.snname '_' lower(handles.Model.String{handles.Model.Value}) '_grid'],handles.MinTPoints.UserData, peakNumber);
...
'Value',1,...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[155.666666666667 60.3333333333333 10.8333333333333 2.16666666666666],...
...
'Title','Plot Model',...
'Tag','ModelParams',...
'Position',[99.8333333333333 0.666666666666667 79.3333333333333 16.8333333333333],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
'String','Model:',...
'Style','text',...
'Position',[3 12.4166666666667 10 2],...
'Children',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','ModelText');
...
'Value',1,...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[20.1666666666667 12.3333333333333 8.5 2.08333333333333],...
...
'String','Progenitor:',...
'Style','text',...
'Position',[31 12.4166666666667 10 2],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'Value',1,...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[44.6666666666667 12.3333333333333 8.5 2.08333333333333],...
...
'Style','text',...
'Position',[2.83333333333333 9.41666666666667 18.1666666666667 2],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','1000',...
'Style','edit',...
'Position',[20 10.0833333333333 8.66666666666666 1.91666666666667],...
'Children',[],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','Rs');
...
'String','v_{s*,8.5}:',...
'Style','text',...
'Position',[30.8333333333333 9.58333333333333 10 2],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','1.002',...
'Style','edit',...
'Position',[44.5 10.0833333333333 8.66666666666666 1.91666666666667],...
...
'String','M_{ej} [M_{\sun}]:',...
'Style','text',...
'Position',[2.83333333333333 7.08333333333333 16.3333333333333 2],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','16.4',...
'Style','edit',...
'Position',[20 7.75 8.667 1.91666666666667],...
...
'String','1.000',...
'Style','edit',...
'Position',[44.5 7.75 8.66666666666666 1.91666666666667],...
...
'String','t_{\ref}:',...
'Style','text',...
'Position',[2.83333333333333 4.33333333333333 16.3333333333333 2],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','54326.45',...
'Style','edit',...
'Position',[20 4.91666666666667 8.66666666666666 1.91666666666667],...
...
'String','E_{B-V}:',...
'Style','text',...
'Position',[31.1666666666667 4.41666666666667 10 2],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'String','0.235',...
'Style','edit',...
'Position',[44.5 4.91666666666667 8.66666666666666 1.91666666666667],...
...
'String','Plot Graph',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[58.1666666666667 12.1666666666667 16.8333333333333 2.25],...
...
'String','Clear Graph',...
'Style',get(0,'defaultuicontrolStyle'),...
'Position',[58 9.16666666666667 16.8333333333333 2.25],...
...
'String','Background:',...
'Style','text',...
'Position',[171.5 60.1666666666667 11.8333333333333 2.25],...
'Children',[],...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'Value',1,...
'ValueMode',get(0,'defaultuicontrolValueMode'),...
'Position',[184.666666666667 60.5833333333333 29 1.83333333333334],...
...
'Style','edit',...
'Value',get(0,'defaultuicontrolValue'),...
'Position',[216.5 60.3333333333333 8.83333333333334 2.16666666666666],...
...
'Style','edit',...
'Value',get(0,'defaultuicontrolValue'),...
'Position',[226.5 60.3333333333333 8.83333333333334 2.16666666666666],...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
...
'String','±',...
'Style','text',...
'Position',[225.166666666667 60.6666666666667 1.33333333333334 1.33333333333334],...
'Children',[],...
