...
DefV.FWHM         = 2.5; % 2.5; %2.5; %3.7;          % ["]  Point source image FWHM (FWHM=2.3548\sigma) [including pixel size, optics, diffraction, jitter, charge leakage]
%--- CCD ---
...
DefV.RN           = 2.*sqrt(5000); %1.5; %1.5; %1.5; %1.5; %4.*sqrt(DefV.ReadRate./250);;           % [e-]      CCD Read noise
...
%--- Exposure ---
DefV.ExpTime      = 30; %30; %1./30;           % expoure time per a single CRsplit
